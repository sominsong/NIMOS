...
Thie module is for finding patterns between
system call sequences extracted from the exploit codes.
The algorithm to find the pattern uses the GSP algorithm.
The format of the pattern is an N-gram pattern classified by length N.
